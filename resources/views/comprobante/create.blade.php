...
@section('title', 'Agregar Comprobante')
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('comprobante.index') }}" class="btn btn-danger d-none d-sm-inline-block texto">
            ...
            <div class="row row-deck row-cards">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('comprobante.store') }}" id="ajaxForm" role="form"

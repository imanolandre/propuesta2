...
@section('title', 'Vista Comprobante')
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="font-size: 15px;">
                            ...
                            ${{ $comprobante->total }} MXN
                            </div>
                            <div class="form-group" style="margin-bottom: 5px;">
                            <strong>Monto Pagado:</strong>
                            ${{ $comprobante->anticipo }} MXN
                            </div>
                            <div class="form-group" style="margin-bottom: 5px;">
                            ...
                            <div class="form-group d-flex justify-content-between" style="margin-bottom: 5px;">
                                ...
                                <span class="col">{{ pathinfo($comprobante->adjunto)['filename'] }}</span>
                                <div class="d-flex align-items-center">
                                    @if ($comprobante->adjunto)
                                    <div class="btn-list ml-2">
                                        <!-- Enlace para mostrar PDF en modal -->
                                        <a href="#" onclick="mostrarPDF('{{ asset($comprobante->adjunto) }}', '{{ pathinfo($comprobante->adjunto)['filename'] }}');" class="btn btn-youtube d-none d-sm-inline-block texto" data-bs-toggle="modal" data-bs-target="#pdfModal">
                                        ...
                                        <a href="#" onclick="mostrarPDF('{{ asset($comprobante->adjunto) }}', '{{ pathinfo($comprobante->adjunto)['filename'] }}');" class="btn btn-youtube d-sm-none btn-icon" data-bs-toggle="modal" data-bs-target="#pdfModal">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon-tada icon-tabler icon-tabler-file-type-pdf ml-2" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M5 12v-7a2 2 0 0 1 2 -2h7l5 5v4" /><path d="M5 18h1.5a1.5 1.5 0 0 0 0 -3h-1.5v6" /><path d="M17 18h2" /><path d="M20 15h-3v6" /><path d="M11 15v6h1a2 2 0 0 0 2 -2v-2a2 2 0 0 0 -2 -2h-1z" /></svg>
                                        </a>
                                    </div>
                                    @endif
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="pdfModalLabel">{{ pathinfo($comprobante->adjunto)['filename'] }}</h5>
                    <div class="d-flex align-items-center">
                        <!-- Ícono de descarga -->
                        @if ($comprobante->adjunto)
                        <a href="{{ asset($comprobante->adjunto) }}" download="{{ pathinfo($comprobante->adjunto)['filename'] }}.pdf">

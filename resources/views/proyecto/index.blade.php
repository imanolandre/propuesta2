                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body border-bottom py-3 table-responsive">
                            <table style="margin-top: 55px; font-size:13px;" id="search-proyectos" class="table table-vcenter datatable">
                                <thead>
                                    <tr>
                                        ...
                                        <th><a class="table-header">Tipo</a></th>
                                        <th><a class="table-header">Servicio</a></th>
                                        <th><a class="table-header">Fecha inicio</a></th>
                                        <th><a class="table-header">Fecha fin</a></th>
                                        <th class="w-1"></th>
                                    </tr>
                                </thead>
...
<script>
    $(document).ready(function () {
        new DataTable('#search-proyectos', {
            responsive: true,
            autoWidth: false,
            language: {

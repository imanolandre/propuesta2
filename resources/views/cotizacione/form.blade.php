...
<div class="row">
    ...
    <div class="col-md-6" id="campos_servicio_adicional_1" style="display: none;">
        <div class="form-group mb-3">
            <label class="form-label">{{ Form::label('servicio adicional1') }}</label>
            <div>
                {{ Form::text('servicioadicional1', $cotizacione->servicioadicional1, ['class' => 'form-control' .
    ...
    <div class="col-md-3" id="campos_importe_adicional_1" style="display: none;">
        <div class="form-group mb-3">
            <label class="form-label">{{ Form::label('importe adicional1') }}</label>
            <div>
                {{ Form::text('importeadicional1', $cotizacione->importeadicional1, ['class' => 'form-control' .
    ...
    <div class="col-md-6" id="campos_servicio_adicional_2" style="display: none;">
        <div class="form-group mb-3">
            <label class="form-label">{{ Form::label('servicio adicional2') }}</label>
            <div>
                {{ Form::text('servicioadicional2', $cotizacione->servicioadicional2, ['class' => 'form-control' .
    ...
    <div class="col-md-3" id="campos_importe_adicional_2" style="display: none;">
        <div class="form-group mb-3">
            <label class="form-label">{{ Form::label('importe adicional2') }}</label>
            <div>
                {{ Form::text('importeadicional2', $cotizacione->importeadicional2, ['class' => 'form-control' .
    ...
    <div class="col-md-6" id="campos_servicio_adicional_3" style="display: none;">
        <div class="form-group mb-3">
            <label class="form-label">{{ Form::label('servicio adicional3') }}</label>
            <div>
                {{ Form::text('servicioadicional3', $cotizacione->servicioadicional3, ['class' => 'form-control' .
    ...
    <div class="col-md-3" id="campos_importe_adicional_3" style="display: none;">
        <div class="form-group mb-3">
            <label class="form-label">{{ Form::label('importe adicional3') }}</label>
            <div>
                {{ Form::text('importeadicional3', $cotizacione->importeadicional3, ['class' => 'form-control' .
    ...
    <div class="col-md-6" id="campos_servicio_adicional_4" style="display: none;">
        <div class="form-group mb-3">
            <label class="form-label">{{ Form::label('servicio adicional4') }}</label>
            <div>
                {{ Form::text('servicioadicional4', $cotizacione->servicioadicional4, ['class' => 'form-control' .
    ...
    <div class="col-md-3" id="campos_importe_adicional_4" style="display: none;">
        <div class="form-group mb-3">
            <label class="form-label">{{ Form::label('importe adicional4') }}</label>
            <div>
                {{ Form::text('importeadicional4', $cotizacione->importeadicional4, ['class' => 'form-control' .
    ...
    <div class="col-md-6" id="campos_servicio_adicional_5" style="display: none;">
        <div class="form-group mb-3">
            <label class="form-label">{{ Form::label('servicio adicional5') }}</label>
            <div>
                {{ Form::text('servicioadicional5', $cotizacione->servicioadicional5, ['class' => 'form-control' .
    ...
    <div class="col-md-3" id="campos_importe_adicional_5" style="display: none;">
        <div class="form-group mb-3">
            <label class="form-label">{{ Form::label('importe adicional5') }}</label>
            <div>
                {{ Form::text('importeadicional5', $cotizacione->importeadicional5, ['class' => 'form-control' .

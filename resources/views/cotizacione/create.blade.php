...
@section('title', 'Agregar Cotizacion')
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('cotizaciones.index') }}" class="btn btn-danger d-none d-sm-inline-block texto">
                        ...
                        <a href="{{ route('cotizaciones.index') }}" class="btn btn-danger d-sm-none btn-icon">
                            <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon-pulse icon-tabler icon-tabler-x" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M18 6l-12 12" /><path d="M6 6l12 12" /></svg>
                        </a>
                    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Información de Cotización</h3>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('cotizaciones.store') }}" id="ajaxForm" role="form"

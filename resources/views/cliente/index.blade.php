                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body border-bottom py-3 table-responsive">
                            <table style="margin-top: 55px; font-size:13px;" id="search-clientes" class="table table-vcenter datatable">
                                <thead>
                                    <tr>
                                        <th class="w-1"><a class="table-header">No.</a></th>
                                        <th><a class="table-header">Nombre del cliente</a></th>
                                        <th><a class="table-header">Correo</a></th>
                                        <th><a class="table-header">Teléfono</a></th>
                                        <th><a class="table-header">Empresa</a></th>
                                        <th><a class="table-header">Sitio web</a></th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>

...
<div class="row">
    <div class="col-md-6">
        <div class="form-group mb-3">
            ...
            <div>
                {{ Form::text('nombrecliente', $cliente->nombrecliente, ['class' => 'form-control texto' . ($errors->has('nombrecliente') ? ' is-invalid' : ''), 'placeholder' => 'Nombre cliente']) }}
    ...
    <div class="col-md-3">
        <div class="form-group mb-3">
            ...
            <div>
                {{ Form::text('correo', $cliente->correo, ['class' => 'form-control texto' . ($errors->has('correo') ? ' is-invalid' : ''), 'placeholder' => 'Correo']) }}
    ...
    <div class="col-md-3">
        <div class="form-group mb-3">
            ...
            <div>
                {{ Form::text('teléfono', $cliente->teléfono, ['class' => 'form-control texto' . ($errors->has('teléfono') ? ' is-invalid' : ''), 'placeholder' => 'Teléfono']) }}
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            ...
            <div>
                {{ Form::text('empresa', $cliente->empresa, ['class' => 'form-control texto' . ($errors->has('empresa') ? ' is-invalid' : ''), 'placeholder' => 'Empresa']) }}
    ...
    <div class="col-md-3">
        <div class="form-group mb-3">
            ...
            <div>
                {{ Form::text('sitioweb', $cliente->sitioweb, ['class' => 'form-control texto' . ($errors->has('sitioweb') ? ' is-invalid' : ''), 'placeholder' => 'Sitio web']) }}
    ...
    <div class="col-md-3">
        <div class="form-group mb-3">
            ...
            <div>
                {{ Form::text('dirección', $cliente->dirección, ['class' => 'form-control texto' . ($errors->has('dirección') ? ' is-invalid' : ''), 'placeholder' => 'Dirección']) }}
...
<p>
    <div class="col-md-6">
        <div class="form-group mb-3">
            ...
            <div>
                {{ Form::text('razónsocial', $cliente->razónsocial, ['class' => 'form-control texto' .
                ($errors->has('razónsocial') ? ' is-invalid' : ''), 'placeholder' => 'Razón social']) }}
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            ...
            <div>
                {{ Form::text('direcciónfiscal', $cliente->direcciónfiscal, ['class' => 'form-control texto' .
                ($errors->has('direcciónfiscal') ? ' is-invalid' : ''), 'placeholder' => 'Dirección fiscal']) }}
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            ...
            <div>
                {{ Form::text('rfc', $cliente->rfc, ['class' => 'form-control texto' .
    ...
    <div class="col-md-3">
        <div class="form-group mb-3">
            ...
            <div>
                {{ Form::text('codigopostal', $cliente->codigopostal, ['class' => 'form-control texto' .
                ($errors->has('codigopostal') ? ' is-invalid' : ''), 'placeholder' => 'Codigo postal']) }}
        ...
        <div class="form-group mb-3">
            ...
            <div>
                {{ Form::select('regimenincorporación', [
                    ...
                    ], $cliente->regimenincorporación, ['class' => 'form-control form-select texto' . ($errors->has('regimenincorporación') ? ' is-invalid' : ''),'placeholder' => 'Seleccione regimen']) }}
    ...
    <div class="form-group form3">
        ...
        <label>
            {{ Form::file('constanciasituaciónFiscal', ['class' =>'form-control form-label texto' . ($errors->has('constanciasituaciónFiscal') ? ' is-invalid' : '')]) }}
        </label>

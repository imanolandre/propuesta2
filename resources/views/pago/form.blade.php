...
<div class="row">
    <div class="col-md-4">
        <div class="form-group mb-3">
            <label class="form-label">{{ Form::label('fecha', 'Fecha de Pago') }}</label>
            <div>
    ...
    <div class="col-md-4">
        <div class="form-group mb-3">
            <label class="form-label">   {{ Form::label('monto $ MXN') }}</label>
            <div>
    ...
    <div class="col-md-4">
        <div class="form-group mb-3">
            <label class="form-label">   {{ Form::label('gastos $ MXN') }}</label>
            <div>
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            <label class="form-label">   {{ Form::label('concepto del gasto') }}</label>
            <div>
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            <label class="form-label">   {{ Form::label('proyecto_id', 'Nombre del proyecto') }}</label>
            <div>
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            <label class="form-label">{{ Form::label('imagen Adjunto') }}</label>
            <div>

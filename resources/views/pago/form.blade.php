...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            ...
            <div>
                {{ Form::select('proyecto_id', $proyectos, $pago->proyecto_id, ['class' => 'tom-select form-control form-select select2' . ($errors->has('proyecto_id') ? ' is-invalid' : ''),'placeholder' => 'Selecciona un proyecto'])}}

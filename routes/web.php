...
Route::resource('/comprobante', ComprobanteController::class)->middleware('auth');;
Route::get('obtener-nombre-cliente/{proyectoId}', [PagoController::class, 'obtenerNombreCliente']);
Route::get('/obtener-datos-cotizacion/{cotizacionId}', [ComprobanteController::class, 'obtenerDatosCotizacion']);
